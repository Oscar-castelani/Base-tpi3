// public/scripts/hogar.js

document.addEventListener('DOMContentLoaded', () => {
  try {
    fetch('http://localhost:3000/api/products/hogar')
      ...
      .catch(error => {
        console.error('Error fetching hogar products:', error);
      });
  } catch (e) {
    console.log('try-catch error en hogar.js');
    console.log(e);
  }
});
